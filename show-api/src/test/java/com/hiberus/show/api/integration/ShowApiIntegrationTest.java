...
public class ShowApiIntegrationTest {
    ...
    public void setup() {
        ...
        mongoTemplate.save(Show.builder()
                .name("Tenet")
                .identifier("1")
                .availablePlatforms(new String[]{"HBO"})
                .build(), SHOWS_COLLECTION);
    }

    @Test
    public void testFindAll() throws Exception {
        MvcResult result = mockMvc.perform(get("/show/all")).andExpect(status().isOk()).andReturn();
        assertThat(result.getResponse().getContentAsString()).isEqualTo(objectMapper.writeValueAsString(new ShowDto[]{ShowDto.builder()
                .title("Tenet")
                .availablePlatforms(new String[]{"HBO"})
                .identifier("1")
                .build()}));
    ...
    public void testFindById() throws Exception {
        ...
        assertThat(result.getResponse().getContentAsString()).isEqualTo(objectMapper.writeValueAsString(ShowDto.builder()
                .title("Tenet")
                .availablePlatforms(new String[]{"HBO"})
                .identifier("1")
                .build()));
